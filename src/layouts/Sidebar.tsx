...
export function Sidebar() {
    ...
    {/*Large Sidebar for larger screens*/}
    <aside className="hidden lg:flex w-56 lg:sticky absolute top-0 overflow-y-auto scrollbar-hidden pb-4 flex-col gap-2 px-2">
        <LargeSidebarSection >
            <LargeSidebarItem isActive IconOrImgUrl={Home} title="Home" url="/" />
            <LargeSidebarItem IconOrImgUrl={Clapperboard} title="Suscriptions" url="/suscriptions" />
        </LargeSidebarSection>
        <hr/>
...
function LargeSidebarSection({
    ...
    const showExpendedButton = childrenArray.length > visibleItemCount
